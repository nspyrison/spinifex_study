---
title: Supplementary Materials; Study on User-Controlled Radial Tour
...
Clusters of the EVV shape are transformed into the banana-chevron shape. Then location mixing is applied by post-multiplying a rotation matrix to the signal variable and a noise variable for the clusters in question.<!-- Preprocess and replicate and save --> All variables are then standardized by standard deviations away from the mean. The columns are then shuffled randomly.
