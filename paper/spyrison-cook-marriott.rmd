...
\begin{array}{l}
\text{where} \\
~~I() \text{ is the indicator function, a binary response}
\\
...
<!-- CONVERTED TO SEPRATE SUPPLEMENTAL MATERIALS -->
<!-- \newpage -->
