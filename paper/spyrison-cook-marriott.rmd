...
```{r figExpFactors, out.width='85%', fig.cap = "Illustration of the experimental factors, the parameter space of the independent variables."}
if(F)
...
kableExtra::kbl(
  coef_ls[[1]], format = "latex", escape = TRUE, booktabs = TRUE, linesep = "", digits = 5,
  ...
  kableExtra::kable_classic(font_size = 12) # bootstrap_options = "striped",
```
