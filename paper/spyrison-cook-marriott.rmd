...
\begin{align*}
  W_{i} &=\frac{(\overline{X_{i=1, k=1}} - \overline{X_{1, 2}}, ~...~ 
    (\overline{X_{p, 1}} - \overline{X_{p, 2}})}
    {\sum_{i=1}^{p}(|\overline{X_{i, k=1}} - \overline{X_{i, k=2}}|)} - \frac{1}{p} \\
\\
...
Where $I$ is the indicator function. Then the task accuracy is the sum of this vector.
