...
keywords: ["Linear Dimension Reduction", "Visual Analytics", "Grand Tour", "Data Science", "Machine Learning", "XAI"]
abstract: |
...
Whether an analyst uses PCA or the grand tour, they cannot influence the basis. They cannot explore the structure identified or change the contribution of the variables. User-control-steering is a key aspect of _manual_ tours helps to test variable attribution.
...
@chang_evaluation_2018 conducted an $n=51$ participant study comparing parallel coordinate plots and SPLOM either in isolation, sequentially, or as a coordinated view. Accuracy, completion time, and eye focus were measured for six tasks. Three tasks were more accurate with SPLOM and three with parallel coordinates, while the coordinated view was usually marginally more accurate than the max of the separate visuals. @cao_z-glyph_2018 compare unstandardized line-glyph and star-glyphs with standardized variants (with and without curve fill). Each of the $n=18$ participants performed 72 trials across the six visuals, two levels of dimensions, and two levels of observations. Visuals with variable standardization outperformed the unstandardized variants, and the radial star-glyph reportedly outperformed line-variant.
...
```{r figExpFactors, out.width='85%', fig.env = "figure*", fig.cap = "Illustration of the experimental factors, the parameter space of the independent variables."}
if(F)
