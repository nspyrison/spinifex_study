...
df1 <- read.csv2("./apps_supplementary/v1_pilot_studies/responses_1_v3pilot_Judy.csv", sep = ",", stringsAsFactors = F)
df2 <- read.csv2("./apps_supplementary/v1_pilot_studies/responses_1_v3pilot_Sabrina.csv", sep = ",", stringsAsFactors = F)
df <- rbind(df1, df2)
