...
This section covers an accompanying graphical user interface for condcting radial tours and extended analysis. First, this analysis explores the demographics of the participants. Then a parallel modeling analysis is performed regressing log response time. Lastly, we look at the effect ranges and marginal effects of the random effect of the participants and data simulation. 
