...
\text{L: }&&    \widehat{marks} =& \beta_{0} + \Sigma_{l = 1}^3(\alpha_{l} \* \beta_{l}) + effect_{participant} + \epsilon \\
\text{L: }&&     \widehat{marks} =& \beta_{0} + \Sigma_{l = 1}^3(\alpha_{l} \* \beta_{l}) + effect_{participant} + \epsilon \\
\text{S: }&&     \widehat{marks} =& \beta_{0} + \Sigma_{s = 1}^3(\alpha_{s} \* \beta_{s}) + effect_{participant} + \epsilon \\
\text{D: }&&     \widehat{marks} =& \beta_{0} + \Sigma_{d = 1}^2(\alpha_{d} \* \beta_{d}) effect_{participant} + \epsilon \\
\text{O: }&&     \widehat{marks} =& \beta_{0} + \Sigma_{o = 1}^6(\alpha_{o} \* \beta_{o}) + effect_{participant} + \epsilon \\
...
&& & \Sigma_{o = 1}^6(\alpha_{o} \* \beta_{o}) + effect_{participant} + \epsilon \\
...
&l \in (0/100,~33/66,~50/50) \text{ percent mixing of a noise and signal variable respectively} \\
&shape~s \in (EEE,~EEV,~EVV~banana) \\
&dim~d \in (4,~6) \text{ variables, dimensions of the data with 3 \& 4 clusters respectively} \\
&order~o \in (1,~... ~6) \text{, order of evaluation within participant, as a factor rather than numeric variable}
\end{align*}
...
_TODO: XXX NEED survey models listed. vvv_
\begin{align*}
\textbf{Abbreviation:}&&    \textbf{Model:~~} & \\
\text{marks=F+RE(participant):}&&   \widehat{marks} =& \beta_{0} + \Sigma_{f = 1}^3(\alpha_{} \* \beta_{f}) + effect_{participant} + \epsilon \\
\text{marks=F+RE(participant+simulation):}&&   \widehat{marks} =& \beta_{0} + \Sigma_{f = 1}^3(\alpha_{f} \* \beta_{f}) + effect_{participant} + effect_{simulation} + \epsilon \\
\text{model time=F+RE(participant):}&&   \widehat{marks} =& \beta_{0} + \Sigma_{f = 1}^3(\alpha_{f} \* \beta_{f}) + effect_{participant} + \epsilon \\
\text{model time=F+RE(participant+simulation):}&&   \widehat{marks} =& \beta_{0} + \Sigma_{f = 1}^3(\alpha_{f} \* \beta_{f}) + effect_{participant} + effect_{simulation} + \epsilon \\
\end{align*}
...
\end{align*}
_TODO: XXX NEED survey models listed.  ^^^_
