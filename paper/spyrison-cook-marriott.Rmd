...
<!-- Background for methodology, applicationn here -->
...
<!-- Dimensionality -->
We test 2 levels of dimensionality, 4 dimensions containing 3 clusters and 6 dimensions with 4 clusters. Each cluster samples 140 observations. Each dimension is originally distributed as $\mathcal{N}(2 * I(signal), 1)$ (before signal mixing and standardizing by standard deviation).
...
Within each factor there is one training trial, followed by 2 time-limited evaluation trials. The training trial always happen with the simplest parameterization 
...
_figure idea; abstract map side by side with permutation nesting img not perticularly interesting or crutial to cretiquing the study_
