...
\alpha \* \beta \* \gamma&& \widehat{marks} =& \textbf{Z} \* \mu + \alpha_i * \beta_j * \gamma_k + \epsilon \\
\alpha \* \beta \* \gamma \* \delta&& \widehat{marks} =& \textbf{Z} \* \mu + \alpha_i + \beta_j \* \gamma_k \* \delta_l + \epsilon \\
\end{align*}
...
kableExtra::kbl(ABC_coef) %>%
  kableExtra::column_spec(column = 1, width = "4cm") %>%
  kableExtra::column_spec(column = c(2:3), width = "2.2cm") %>%
  kableExtra::column_spec(column = c(4,6), width = "1.6cm") %>%
  kableExtra::column_spec(column = 5, width = "2cm") %>% 
...
knitr::include_graphics("./figures/figSubjectiveMeasures_w.violins_hori.png") ## Alternatively use the suffix *_vert
# figSubjectiveMeasures_vert.png
# figSubjectiveMeasures_hori.png
# figSubjectiveMeasures_w.violins_vert.png
# figSubjectiveMeasures_w.violins_hori.png
```
