...
rel_path <- function(rel_path){
  paste0(dirname(rstudioapi::getSourceEditorContext()$path), "/", rel_path)
}
...
TODO: XXX
FIGURE OF DECIPTING EVALUATION NEXT TO PCA OF THE SEPERATION
