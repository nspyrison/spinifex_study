...
if(F){
  ...
  .no_legend <- list(theme(legend.position = "off"),
                     ggtitle(""))
  gc()
  figMarksByCond_notitle <- 
    cowplot::plot_grid(marks_by_factor + .no_legend + ggtitle(""),
                       ...
                       ncol = 5, rel_widths = c(4, rep(3, 4))) + margin(-5,0,0,0)
  
  title <- cowplot::ggdraw() +
      cowplot::draw_label("Marks by conditional block parameter",
                          x = .15, y = .6, hjust = .1, vjust = .5)
  gc()
  figMarksByCond <- cowplot::plot_grid(title, figMarksByCond_notitle,
                                  ncol = 1, rel_heights = c(0.1, 1))
  ggsave("figMarksByCond.png", plot = figMarksByCond, path = "./paper/figures",
