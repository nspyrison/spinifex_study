...
<!-- # } -->
<!-- # ``` -->
<!-- # ![](output/ggcorr_clConcinna .png) -->
<!-- # ![](output/ggcorr_clHeptapot. .png) -->
<!-- # ![](output/ggcorr_clHeikert. .png) -->
...
ggplot() + ggproto_MMP_clSep(dat, clas) +
...
if (DO_RERUN_HEAVY_OUTPUT == TRUE) {
  ...
  .gg <- ggplot() + ggproto_MMP_clSep(data = dat, class = clas)
...
```
![](output/sim_case1_MMP_clSep.png)
![](output/sim_case2_MMP_clSep.png)
![](output/sim_case3_MMP_clSep.png)
![](output/sim_case4_MMP_clSep.png)
...
if (DO_RERUN_SIM302_PAIRS_n_TOURGIFS == TRUE) {
  ...
  for (i in 1:ncol(dat)){
    play_manual_tour(basis = pca_bas, data = dat, manip_var = 1)
...
![](output/radialTour_sim302_mvar1.gif)
![](output/radialTour_sim302_mvar2.gif)
![](output/radialTour_sim302_mvar3.gif)
![](output/radialTour_sim302_mvar4.gif)
![](output/radialTour_sim302_mvar5.gif)
![](output/radialTour_sim302_mvar6.gif)
