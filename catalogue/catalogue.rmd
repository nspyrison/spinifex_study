...
## Load data
obj_nms <- c("VII_3310", "EEE_3310", "VVV_3310")
...
1. All clusters recieve the same number of observations, regardless of volume.
  ...
  for(i in i_s) {
    ...
    for (j in 1:length(tour_manip_nums)){
      ...
      play_manual_tour(basis = pca_bas,
                       data = dat,
                       fps = 9L,
                       manip_var = tour_manip_nums[j],
                       render_type = render_gganimate,
                       col = clas, pch = clas,
                       axes = "left",
                       gif_filename = paste0("radialTour_", sim_nm, 
                                             "_mvar", tour_manip_nums[j], ".gif"),
                       gif_path = console_path
                       #### TODO ## Causing an Error "Unkown input ScaleDiscrete" (or List)  as of 08/09/2020...
                       ,ggtheme = list(
...
<!-- ![](images/radialTour_VII_3310_mvar2.gif) -->
<!-- ![](images/radialTour_VII_3310_mvar1.gif) -->
