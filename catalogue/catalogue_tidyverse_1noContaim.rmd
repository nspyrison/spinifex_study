...
```{r, initialize}
## SETUP MODELS, MEANS
models <- c("EEE", "EEV", "VVV_banana", "VVV_boomerang")
p      <- 4
k_cl   <- 3
...
VVV_banana[VVV_banana$cl == "cl b", ] <- banana(VVV_banana[VVV_banana$cl == "cl b", ])
assign(models[4], this_sim(get(paste0("covs_", models[4]))))
## Apply boomerang() to cl b.
VVV_boomerang[VVV_boomerang$cl == "cl b", 2:5] <-
  boomerang(VVV_boomerang[VVV_boomerang$cl == "cl b", 2:5])
...
![](images/radialTour_tidyverse_VVV_banana_mvar1.gif)
![](images/radialTour_tidyverse_VVV_banana_mvar2.gif)
![](images/radialTour_tidyverse_VVV_banana_mvar3.gif)

## `r models[4]`

![](images/radialTour_tidyverse_VVV_boomerang_mvar1.gif)
![](images/radialTour_tidyverse_VVV_boomerang_mvar2.gif)
![](images/radialTour_tidyverse_VVV_boomerang_mvar3.gif)
