---
title: "Catalogue -- tidyverse simulations, (2/3, noise correlation) "
output:
  html_document:
    toc: true
    toc_depth: 3
...
```{r, initialize}
## SETUP MODELS, MEANS
models <- paste0(c("EEE", "EEV", "VVV_banana", "VVV_boomerang"), "_noise_cor")
p      <- 4
k_cl   <- 3
...
assign(paste0("covs_", models[4]),
       list("cl a" = .2 *  cov_circ_noise_cor,
            "cl b" = .05 * cov_circ_noise_cor, ## Apply boomerang() to cl_b
            "cl c" = cov_elipse_pos_noise_cor))
...
VVV_boomerang_noise_cor[VVV_boomerang_noise_cor$cl == "cl b", 2:5] <-
  boomerang(VVV_boomerang_noise_cor[VVV_boomerang_noise_cor$cl == "cl b", 2:5])
...
![](images/radialTour_tidyverse_VVV_banana_noise_cor_mvar1.gif)
![](images/radialTour_tidyverse_VVV_banana_noise_cor_mvar2.gif)
![](images/radialTour_tidyverse_VVV_banana_noise_cor_mvar3.gif)

## `r models[4]`

![](images/radialTour_tidyverse_VVV_boomerang_noise_cor_mvar1.gif)
![](images/radialTour_tidyverse_VVV_boomerang_noise_cor_mvar2.gif)
![](images/radialTour_tidyverse_VVV_boomerang_noise_cor_mvar3.gif)
