---
title: "Catalogue -- tidyverse simulations, (3/3, rotation) "
output:
  html_document:
    toc: true
    toc_depth: 3
...
```{r, initialize}
## SETUP MODELS, MEANS
models <- paste0(c("EEE", "EEV", "VVV_banana", "VVV_boomerang"), "_rot")
p      <- 4
k_cl   <- 3
...
## ASSIGN GENERATED __ROTATED__ SIMS
assign(models[1], rotate(this_sim(get(paste0("covs_", models[1])))))
assign(models[2], rotate(this_sim(get(paste0("covs_", models[2])))))
assign(models[3], rotate(this_sim(get(paste0("covs_", models[3]))))) 
## Apply banana() to cl b.
VVV_banana_rot[VVV_banana_rot$cl == "cl b", ] <-
  banana(VVV_banana_rot[VVV_banana_rot$cl == "cl b", ])
assign(models[4], this_sim(get(paste0("covs_", models[4]))))
## Apply boomerang() to cl b.
VVV_boomerang_rot[VVV_boomerang_rot$cl == "cl b", 2:5] <-
  boomerang(VVV_boomerang_rot[VVV_boomerang_rot$cl == "cl b", 2:5])
...
![](images/model_families.png)
![](images/model_banana.png)
![](images/model_boomerang.png)
...
design <- data.frame(
  ...
  `VVV_banana family` = 
    c("VVV_banana", "VVV_banana_noiseCor", "VVV_banana_rot"),
  `VVV_boomerang family` = 
    c("VVV_boomerang", "VVV_boomerang_noiseCor", "VVV_boomerang_rot"),
  check.names = FALSE
)
...
![](images/radialTour_tidyverse_EEE_rot_mvar1.gif)
![](images/radialTour_tidyverse_EEE_rot_mvar2.gif)
![](images/radialTour_tidyverse_EEE_rot_mvar3.gif)

## `r models[2]`

![](images/radialTour_tidyverse_EEV_rot_mvar1.gif)
![](images/radialTour_tidyverse_EEV_rot_mvar2.gif)
![](images/radialTour_tidyverse_EEV_rot_mvar3.gif)

## `r models[3]`

![](images/radialTour_tidyverse_VVV_banana_rot_mvar1.gif)
![](images/radialTour_tidyverse_VVV_banana_rot_mvar2.gif)
![](images/radialTour_tidyverse_VVV_banana_rot_mvar3.gif)

## `r models[4]`

![](images/radialTour_tidyverse_VVV_boomerang_rot_mvar1.gif)
![](images/radialTour_tidyverse_VVV_boomerang_rot_mvar2.gif)
![](images/radialTour_tidyverse_VVV_boomerang_rot_mvar3.gif)
