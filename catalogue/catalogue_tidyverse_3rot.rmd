...
```{r, initialize}
## SETUP MODELS, MEANS
models <- paste0(c("EEE", "EEV", "VVV_banana", "VVV_boomerang"), "_mnComb")
p      <- 4
k_cl   <- 3
...
## ASSIGN GENERATED __mnCombATED__ SIMS
...
VVV_banana_mnComb[VVV_banana_mnComb$cl == "cl b", ] <-
  banana(VVV_banana_mnComb[VVV_banana_mnComb$cl == "cl b", ])
assign(models[4], this_sim(get(paste0("covs_", models[4]))))
## Apply boomerang() to cl b.
VVV_boomerang_mnComb[VVV_boomerang_mnComb$cl == "cl b", 2:5] <-
  boomerang(VVV_boomerang_mnComb[VVV_boomerang_mnComb$cl == "cl b", 2:5])
...
design <- data.frame(
  ...
  `VVV_banana family` = 
    c("VVV_banana", "VVV_banana_noiseCor", "VVV_banana_mnComb"),
  `VVV_boomerang family` = 
    c("VVV_boomerang", "VVV_boomerang_noiseCor", "VVV_boomerang_mnComb"),
  check.names = FALSE
)
...
![](images/radialTour_tidyverse_EEE_mnComb_mvar1.gif)
![](images/radialTour_tidyverse_EEE_mnComb_mvar2.gif)
![](images/radialTour_tidyverse_EEE_mnComb_mvar3.gif)

## `r models[2]`

![](images/radialTour_tidyverse_EEV_mnComb_mvar1.gif)
![](images/radialTour_tidyverse_EEV_mnComb_mvar2.gif)
![](images/radialTour_tidyverse_EEV_mnComb_mvar3.gif)

## `r models[3]`

![](images/radialTour_tidyverse_VVV_banana_mnComb_mvar1.gif)
![](images/radialTour_tidyverse_VVV_banana_mnComb_mvar2.gif)
![](images/radialTour_tidyverse_VVV_banana_mnComb_mvar3.gif)

## `r models[4]`

![](images/radialTour_tidyverse_VVV_boomerang_mnComb_mvar1.gif)
![](images/radialTour_tidyverse_VVV_boomerang_mnComb_mvar2.gif)
![](images/radialTour_tidyverse_VVV_boomerang_mnComb_mvar3.gif)
